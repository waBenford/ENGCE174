...
enum opt_code
{
  ...
  OPT_mamx_avx512 = 2066,                    /* -mamx-avx512 */
  OPT_mamx_bf16 = 2067,                      /* -mamx-bf16 */
  OPT_mamx_complex = 2068,                   /* -mamx-complex */
  OPT_mamx_fp16 = 2069,                      /* -mamx-fp16 */
  OPT_mamx_fp8 = 2070,                       /* -mamx-fp8 */
  OPT_mamx_int8 = 2071,                      /* -mamx-int8 */
  OPT_mamx_movrs = 2072,                     /* -mamx-movrs */
  OPT_mamx_tf32 = 2073,                      /* -mamx-tf32 */
  OPT_mamx_tile = 2074,                      /* -mamx-tile */
  OPT_mamx_transpose = 2075,                 /* -mamx-transpose */
  OPT_mapx_features_ = 2076,                 /* -mapx-features= */
  OPT_mapx_inline_asm_use_gpr32 = 2077,      /* -mapx-inline-asm-use-gpr32 */
  OPT_mapxf = 2078,                          /* -mapxf */
  OPT_march_ = 2079,                         /* -march= */
  OPT_masm_ = 2080,                          /* -masm= */
  OPT_mavx = 2081,                           /* -mavx */
  OPT_mavx10_1 = 2082,                       /* -mavx10.1 */
  OPT_mavx10_1_256 = 2083,                   /* -mavx10.1-256 */
  /* OPT_mavx10_1_512 = 2084, */             /* -mavx10.1-512 */
  OPT_mavx10_2 = 2085,                       /* -mavx10.2 */
  OPT_mavx2 = 2086,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 2087,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 2088,  /* -mavx256-split-unaligned-store */
  OPT_mavx512bf16 = 2089,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 2090,                  /* -mavx512bitalg */
  OPT_mavx512bw = 2091,                      /* -mavx512bw */
  OPT_mavx512cd = 2092,                      /* -mavx512cd */
  OPT_mavx512dq = 2093,                      /* -mavx512dq */
  OPT_mavx512f = 2094,                       /* -mavx512f */
  OPT_mavx512fp16 = 2095,                    /* -mavx512fp16 */
  OPT_mavx512ifma = 2096,                    /* -mavx512ifma */
  OPT_mavx512vbmi = 2097,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 2098,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 2099,                      /* -mavx512vl */
  OPT_mavx512vnni = 2100,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 2101,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 2102,               /* -mavx512vpopcntdq */
  OPT_mavxifma = 2103,                       /* -mavxifma */
  OPT_mavxneconvert = 2104,                  /* -mavxneconvert */
  OPT_mavxvnni = 2105,                       /* -mavxvnni */
  OPT_mavxvnniint16 = 2106,                  /* -mavxvnniint16 */
  OPT_mavxvnniint8 = 2107,                   /* -mavxvnniint8 */
  OPT_mbmi = 2108,                           /* -mbmi */
  OPT_mbmi2 = 2109,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 2110,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 2111,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 2112,                    /* -mcet-switch */
  OPT_mcld = 2113,                           /* -mcld */
  OPT_mcldemote = 2114,                      /* -mcldemote */
  OPT_mclflushopt = 2115,                    /* -mclflushopt */
  OPT_mclwb = 2116,                          /* -mclwb */
  OPT_mclzero = 2117,                        /* -mclzero */
  OPT_mcmodel_ = 2118,                       /* -mcmodel= */
  OPT_mcmpccxadd = 2119,                     /* -mcmpccxadd */
  OPT_mconsole = 2120,                       /* -mconsole */
  /* OPT_mcpu_ = 2121, */                    /* -mcpu= */
  OPT_mcrc32 = 2122,                         /* -mcrc32 */
  OPT_mcrtdll_ = 2123,                       /* -mcrtdll= */
  OPT_mcx16 = 2124,                          /* -mcx16 */
  OPT_mdaz_ftz = 2125,                       /* -mdaz-ftz */
  OPT_mdirect_extern_access = 2126,          /* -mdirect-extern-access */
  OPT_mdispatch_scheduler = 2127,            /* -mdispatch-scheduler */
  OPT_mdll = 2128,                           /* -mdll */
  OPT_mdump_tune_features = 2129,            /* -mdump-tune-features */
  OPT_menqcmd = 2130,                        /* -menqcmd */
  OPT_mevex512 = 2131,                       /* -mevex512 */
  OPT_mf16c = 2132,                          /* -mf16c */
  OPT_mfancy_math_387 = 2133,                /* -mfancy-math-387 */
  OPT_mfentry = 2134,                        /* -mfentry */
  OPT_mfentry_name_ = 2135,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 2136,               /* -mfentry-section= */
  OPT_mfma = 2137,                           /* -mfma */
  OPT_mfma4 = 2138,                          /* -mfma4 */
  OPT_mforce_drap = 2139,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 2140,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 2141,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 2142,                       /* -mfpmath= */
  OPT_mfsgsbase = 2143,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 2144,              /* -mfunction-return= */
  /* OPT_mfused_madd = 2145, */              /* -mfused-madd */
  OPT_mfxsr = 2146,                          /* -mfxsr */
  /* OPT_mgather = 2147, */                  /* -mgather */
  OPT_mgeneral_regs_only = 2148,             /* -mgeneral-regs-only */
  OPT_mgfni = 2149,                          /* -mgfni */
  OPT_mhard_float = 2150,                    /* -mhard-float */
  OPT_mharden_sls_ = 2151,                   /* -mharden-sls= */
  OPT_mhle = 2152,                           /* -mhle */
  OPT_mhreset = 2153,                        /* -mhreset */
  OPT_miamcu = 2154,                         /* -miamcu */
  OPT_mieee_fp = 2155,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 2156,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_cs_prefix = 2157,     /* -mindirect-branch-cs-prefix */
  OPT_mindirect_branch_register = 2158,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 2159,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 2160,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 2161,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 2162,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 2163, */            /* -mintel-syntax */
  OPT_mkl = 2164,                            /* -mkl */
  OPT_mlam_ = 2165,                          /* -mlam= */
  OPT_mlarge_data_threshold_ = 2166,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 2167,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 2168,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 2169,                /* -mlong-double-80 */
  OPT_mlwp = 2170,                           /* -mlwp */
  OPT_mlzcnt = 2171,                         /* -mlzcnt */
  OPT_mmanual_endbr = 2172,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 2173,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 2174,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 2175,                  /* -mmitigate-rop */
  OPT_mmmx = 2176,                           /* -mmmx */
  OPT_mmovbe = 2177,                         /* -mmovbe */
  OPT_mmovdir64b = 2178,                     /* -mmovdir64b */
  OPT_mmovdiri = 2179,                       /* -mmovdiri */
  OPT_mmove_max_ = 2180,                     /* -mmove-max= */
  OPT_mmovrs = 2181,                         /* -mmovrs */
  OPT_mmpx = 2182,                           /* -mmpx */
  OPT_mms_bitfields = 2183,                  /* -mms-bitfields */
  OPT_mmwait = 2184,                         /* -mmwait */
  OPT_mmwaitx = 2185,                        /* -mmwaitx */
  OPT_mneeded = 2186,                        /* -mneeded */
  OPT_mno_align_stringops = 2187,            /* -mno-align-stringops */
  OPT_mno_default = 2188,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 2189,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 2190,                  /* -mno-push-args */
  OPT_mno_red_zone = 2191,                   /* -mno-red-zone */
  OPT_mno_sse4 = 2192,                       /* -mno-sse4 */
  OPT_mnop_fun_dllimport = 2193,             /* -mnop-fun-dllimport */
  OPT_mnop_mcount = 2194,                    /* -mnop-mcount */
  OPT_mnoreturn_no_callee_saved_registers = 2195,/* -mnoreturn-no-callee-saved-registers */
  OPT_momit_leaf_frame_pointer = 2196,       /* -momit-leaf-frame-pointer */
  OPT_mpartial_vector_fp_math = 2197,        /* -mpartial-vector-fp-math */
  OPT_mpc32 = 2198,                          /* -mpc32 */
  OPT_mpc64 = 2199,                          /* -mpc64 */
  OPT_mpc80 = 2200,                          /* -mpc80 */
  OPT_mpclmul = 2201,                        /* -mpclmul */
  OPT_mpcommit = 2202,                       /* -mpcommit */
  OPT_mpconfig = 2203,                       /* -mpconfig */
  OPT_mpe_aligned_commons = 2204,            /* -mpe-aligned-commons */
  OPT_mpku = 2205,                           /* -mpku */
  OPT_mpopcnt = 2206,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 2207, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 2208,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 2209,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchi = 2210,                     /* -mprefetchi */
  OPT_mprfchw = 2211,                        /* -mprfchw */
  OPT_mptwrite = 2212,                       /* -mptwrite */
  OPT_mpush_args = 2213,                     /* -mpush-args */
  OPT_mraoint = 2214,                        /* -mraoint */
  OPT_mrdpid = 2215,                         /* -mrdpid */
  OPT_mrdrnd = 2216,                         /* -mrdrnd */
  OPT_mrdseed = 2217,                        /* -mrdseed */
  OPT_mrecip = 2218,                         /* -mrecip */
  OPT_mrecip_ = 2219,                        /* -mrecip= */
  OPT_mrecord_mcount = 2220,                 /* -mrecord-mcount */
  OPT_mrecord_return = 2221,                 /* -mrecord-return */
  OPT_mred_zone = 2222,                      /* -mred-zone */
  OPT_mregparm_ = 2223,                      /* -mregparm= */
  OPT_mrelax_cmpxchg_loop = 2224,            /* -mrelax-cmpxchg-loop */
  OPT_mrtd = 2225,                           /* -mrtd */
  OPT_mrtm = 2226,                           /* -mrtm */
  OPT_msahf = 2227,                          /* -msahf */
  /* OPT_mscatter = 2228, */                 /* -mscatter */
  OPT_mserialize = 2229,                     /* -mserialize */
  OPT_msgx = 2230,                           /* -msgx */
  OPT_msha = 2231,                           /* -msha */
  OPT_msha512 = 2232,                        /* -msha512 */
  OPT_mshstk = 2233,                         /* -mshstk */
  OPT_mskip_rax_setup = 2234,                /* -mskip-rax-setup */
  OPT_msm3 = 2235,                           /* -msm3 */
  OPT_msm4 = 2236,                           /* -msm4 */
  OPT_msoft_float = 2237,                    /* -msoft-float */
  OPT_msse = 2238,                           /* -msse */
  OPT_msse2 = 2239,                          /* -msse2 */
  OPT_msse2avx = 2240,                       /* -msse2avx */
  OPT_msse3 = 2241,                          /* -msse3 */
  OPT_msse4 = 2242,                          /* -msse4 */
  OPT_msse4_1 = 2243,                        /* -msse4.1 */
  OPT_msse4_2 = 2244,                        /* -msse4.2 */
  OPT_msse4a = 2245,                         /* -msse4a */
  /* OPT_msse5 = 2246, */                    /* -msse5 */
  OPT_msseregparm = 2247,                    /* -msseregparm */
  OPT_mssse3 = 2248,                         /* -mssse3 */
  OPT_mstack_arg_probe = 2249,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 2250, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 2251,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 2252, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 2253,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 2254,                  /* -mstackrealign */
  OPT_mstore_max_ = 2255,                    /* -mstore-max= */
  OPT_mstringop_strategy_ = 2256,            /* -mstringop-strategy= */
  OPT_mstv = 2257,                           /* -mstv */
  OPT_mtbm = 2258,                           /* -mtbm */
  OPT_mthreads = 2259,                       /* -mthreads */
  OPT_mtls_dialect_ = 2260,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 2261,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 2262,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 2263,                    /* -mtune-ctrl= */
  OPT_mtune_ = 2264,                         /* -mtune= */
  OPT_muintr = 2265,                         /* -muintr */
  OPT_municode = 2266,                       /* -municode */
  OPT_munroll_only_small_loops = 2267,       /* -munroll-only-small-loops */
  OPT_muse_libstdc_wrappers = 2268,          /* -muse-libstdc-wrappers */
  OPT_musermsr = 2269,                       /* -musermsr */
  OPT_mvaes = 2270,                          /* -mvaes */
  OPT_mveclibabi_ = 2271,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 2272,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 2273,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 2274,                    /* -mvzeroupper */
  OPT_mwaitpkg = 2275,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 2276,                      /* -mwbnoinvd */
  OPT_mwidekl = 2277,                        /* -mwidekl */
  OPT_mwin32 = 2278,                         /* -mwin32 */
  OPT_mwindows = 2279,                       /* -mwindows */
  OPT_mx32 = 2280,                           /* -mx32 */
  OPT_mxop = 2281,                           /* -mxop */
  OPT_mxsave = 2282,                         /* -mxsave */
  OPT_mxsavec = 2283,                        /* -mxsavec */
  OPT_mxsaveopt = 2284,                      /* -mxsaveopt */
  OPT_mxsaves = 2285,                        /* -mxsaves */
  OPT_n = 2286,                              /* -n */
  OPT_name_sort = 2287,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2288,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2289,              /* -no-integrated-cpp */
  OPT_no_pie = 2290,                         /* -no-pie */
  OPT_no_pthread = 2291,                     /* -no-pthread */
  OPT_nocpp = 2292,                          /* -nocpp */
  OPT_nodefaultlibs = 2293,                  /* -nodefaultlibs */
  OPT_nolibc = 2294,                         /* -nolibc */
  OPT_nomain = 2295,                         /* -nomain */
  OPT_nophoboslib = 2296,                    /* -nophoboslib */
  OPT_nostartfiles = 2297,                   /* -nostartfiles */
  OPT_nostdinc = 2298,                       /* -nostdinc */
  OPT_nostdinc__ = 2299,                     /* -nostdinc++ */
  OPT_nostdlib = 2300,                       /* -nostdlib */
  OPT_nostdlib__ = 2301,                     /* -nostdlib++ */
  OPT_o = 2302,                              /* -o */
  OPT_objects = 2303,                        /* -objects */
  OPT_p = 2304,                              /* -p */
  OPT_pass_exit_codes = 2305,                /* -pass-exit-codes */
  /* OPT_pedantic = 2306, */                 /* -pedantic */
  OPT_pedantic_errors = 2307,                /* -pedantic-errors */
  OPT_pg = 2308,                             /* -pg */
  OPT_pie = 2309,                            /* -pie */
  OPT_pipe = 2310,                           /* -pipe */
  OPT_posix = 2311,                          /* -posix */
  OPT_preprocess = 2312,                     /* -preprocess */
  OPT_print_file_name_ = 2313,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2314,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2315,          /* -print-multi-directory */
  OPT_print_multi_lib = 2316,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2317,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2318,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2319,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2320,               /* -print-prog-name= */
  OPT_print_search_dirs = 2321,              /* -print-search-dirs */
  OPT_print_sysroot = 2322,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2323,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2324,                    /* -print-value */
  OPT_pthread = 2325,                        /* -pthread */
  OPT_quiet = 2326,                          /* -quiet */
  OPT_r = 2327,                              /* -r */
  OPT_remap = 2328,                          /* -remap */
  OPT_reverse_sort = 2329,                   /* -reverse-sort */
  OPT_s = 2330,                              /* -s */
  OPT_save_temps = 2331,                     /* -save-temps */
  OPT_save_temps_ = 2332,                    /* -save-temps= */
  OPT_shared = 2333,                         /* -shared */
  OPT_shared_libgcc = 2334,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2335,               /* -shared-libphobos */
  OPT_size_sort = 2336,                      /* -size-sort */
  /* OPT_specs = 2337, */                    /* -specs */
  OPT_specs_ = 2338,                         /* -specs= */
  OPT_static = 2339,                         /* -static */
  OPT_static_libasan = 2340,                 /* -static-libasan */
  OPT_static_libgcc = 2341,                  /* -static-libgcc */
  OPT_static_libgcobol = 2342,               /* -static-libgcobol */
  OPT_static_libgfortran = 2343,             /* -static-libgfortran */
  OPT_static_libgm2 = 2344,                  /* -static-libgm2 */
  OPT_static_libgo = 2345,                   /* -static-libgo */
  OPT_static_libhwasan = 2346,               /* -static-libhwasan */
  OPT_static_liblsan = 2347,                 /* -static-liblsan */
  OPT_static_libmpx = 2348,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2349,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2350,               /* -static-libphobos */
  OPT_static_libquadmath = 2351,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2352,               /* -static-libstdc++ */
  OPT_static_libtsan = 2353,                 /* -static-libtsan */
  OPT_static_libubsan = 2354,                /* -static-libubsan */
  OPT_static_pie = 2355,                     /* -static-pie */
  /* OPT_std_c__03 = 2356, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2357, */                /* -std=c++0x */
  OPT_std_c__11 = 2358,                      /* -std=c++11 */
  OPT_std_c__14 = 2359,                      /* -std=c++14 */
  OPT_std_c__17 = 2360,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2361, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2362, */                /* -std=c++1z */
  OPT_std_c__20 = 2363,                      /* -std=c++20 */
  OPT_std_c__23 = 2364,                      /* -std=c++23 */
  OPT_std_c__26 = 2365,                      /* -std=c++26 */
  /* OPT_std_c__2a = 2366, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2367, */                /* -std=c++2b */
  /* OPT_std_c__2c = 2368, */                /* -std=c++2c */
  OPT_std_c__98 = 2369,                      /* -std=c++98 */
  OPT_std_c11 = 2370,                        /* -std=c11 */
  OPT_std_c17 = 2371,                        /* -std=c17 */
  /* OPT_std_c18 = 2372, */                  /* -std=c18 */
  /* OPT_std_c1x = 2373, */                  /* -std=c1x */
  OPT_std_c23 = 2374,                        /* -std=c23 */
  /* OPT_std_c2x = 2375, */                  /* -std=c2x */
  OPT_std_c2y = 2376,                        /* -std=c2y */
  /* OPT_std_c89 = 2377, */                  /* -std=c89 */
  OPT_std_c90 = 2378,                        /* -std=c90 */
  OPT_std_c99 = 2379,                        /* -std=c99 */
  /* OPT_std_c9x = 2380, */                  /* -std=c9x */
  OPT_std_f2003 = 2381,                      /* -std=f2003 */
  OPT_std_f2008 = 2382,                      /* -std=f2008 */
  OPT_std_f2008ts = 2383,                    /* -std=f2008ts */
  OPT_std_f2018 = 2384,                      /* -std=f2018 */
  OPT_std_f2023 = 2385,                      /* -std=f2023 */
  OPT_std_f202y = 2386,                      /* -std=f202y */
  OPT_std_f95 = 2387,                        /* -std=f95 */
  OPT_std_gnu = 2388,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2389, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2390, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2391,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2392,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2393,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2394, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2395, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2396,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2397,                    /* -std=gnu++23 */
  OPT_std_gnu__26 = 2398,                    /* -std=gnu++26 */
  /* OPT_std_gnu__2a = 2399, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2400, */              /* -std=gnu++2b */
  /* OPT_std_gnu__2c = 2401, */              /* -std=gnu++2c */
  OPT_std_gnu__98 = 2402,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2403,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2404,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2405, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2406, */                /* -std=gnu1x */
  OPT_std_gnu23 = 2407,                      /* -std=gnu23 */
  /* OPT_std_gnu2x = 2408, */                /* -std=gnu2x */
  OPT_std_gnu2y = 2409,                      /* -std=gnu2y */
  /* OPT_std_gnu89 = 2410, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2411,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2412,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2413, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2414, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2415,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2416, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2417, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2418, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2419, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2420, */         /* -std=iso9899:2018 */
  /* OPT_std_iso9899_2024 = 2421, */         /* -std=iso9899:2024 */
  OPT_std_legacy = 2422,                     /* -std=legacy */
  OPT_stdlib_ = 2423,                        /* -stdlib= */
  OPT_symbol_ = 2424,                        /* -symbol= */
  OPT_symbolic = 2425,                       /* -symbolic */
  OPT_t = 2426,                              /* -t */
  OPT_time = 2427,                           /* -time */
  OPT_time_ = 2428,                          /* -time= */
  OPT_traditional = 2429,                    /* -traditional */
  OPT_traditional_cpp = 2430,                /* -traditional-cpp */
  OPT_tree_stats = 2431,                     /* -tree-stats */
  OPT_trigraphs = 2432,                      /* -trigraphs */
  OPT_truncate = 2433,                       /* -truncate */
  OPT_type_stats = 2434,                     /* -type-stats */
  OPT_u = 2435,                              /* -u */
  OPT_undef = 2436,                          /* -undef */
  OPT_v = 2437,                              /* -v */
  OPT_version = 2438,                        /* -version */
  OPT_w = 2439,                              /* -w */
  OPT_wrapper = 2440,                        /* -wrapper */
  OPT_x = 2441,                              /* -x */
  OPT_z = 2442,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
